...
![](https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/xml_xsd_diff.png)
...
![](https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/diff_viewer_overview.png)
...
<tr>
  ...
  <tr>
    <td><img src="https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/activity_next.png"/></td>
    <td>Navigate to the next difference.<br/>It navigates to the next Activity which has changed.</td>
  </tr>
  <tr>
    <td><img src="https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/activity_prev.png"/></td>
    <td>Navigate to the next difference.<br/>It navigates to the next Activity which has changed.</td>
  </tr>  
</table>
...
![](https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/activity_decoration.png)
...
<tr>
  ...
  <tr>
    <td><img src="https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/property_next.png"/></td>
    <td>Navigate to the next property change.<br/>It navigates to the next property within the current object which has changed.
</td>
  </tr>
  <tr>
    <td><img src="https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/property_prev.png"/></td>
...
![](https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/property_view.png)
...
<tr>
  ...
  <tr>
    <td><img src="https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/activity_added.png"/></td>
    <td>Green “+” indicates a newly added activity.</td>
  </tr>
  <tr>
    <td><img src="https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/activity_deleted.png"/></td>
    <td>Red “-” indicates deletion of an activity.</td>
  </tr>  
  <tr>
    <td><img src="https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/activity_changed.png"/></td>
...
1.	Right-click a process and select Compare > Local History.
	![](https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/local_history.png)
2.	This opens a History view
3.	Select revisions to be compared
4.	Right-click and select Compare with Each Other.
	![](https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/local_history_compare_with_each_other.png)
...
![](https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/diff_viewer.png)
...
2.	Go to Team > Show History
	 ![](https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/svn_history_view.png)
3.	A History view is displayed.
4.	Select revisions you want to compare.
5.	Right-click > Compare...
        ![](https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/svn_history_view.png)
6.	Click OK
        ![](https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/svn_compare_with_revision.png)
...
5.	Right Click and select Compare with Each Other.
        ![](https://github.com/sokulkar/bw-tooling/blob/master/diff-viewer/images/git_history_view.png)
