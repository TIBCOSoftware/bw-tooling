 ...
 * </p>
 *
 * @author David Smiley dsmiley@mitre.org - Source https://github.com/mitre/HTTP-Proxy-Servlet
 */
...
public class ProxyServlet extends HttpServlet {
	 ...
	 * 
	 */
	public ProxyServlet(CountDownLatch initLatch) {
	...
	public void init() throws ServletException {
		...
		if (preserveCookiesString != null) {
			this.doPreserveCookies = Boolean
					.parseBoolean(preserveCookiesString);
		}

		String handleRedirectsString = getConfigParam(P_HANDLEREDIRECTS);
		if (handleRedirectsString != null) {
			this.doHandleRedirects = Boolean
					.parseBoolean(handleRedirectsString);
		}
	...
	protected HttpResponse doExecute(HttpServletRequest servletRequest,
			...
			throws IOException {
		if (doLog) {
			log("proxy " + servletRequest.getMethod() + " uri: "
	...
	protected HttpRequest newProxyRequestWithEntity(String method,
	 ...
	 */
	protected void copyRequestHeader(HttpServletRequest servletRequest,
